      ...
      <div class="col-lg-6 col-md-12 col-12">
          ...
          <div class="px-4">
              <div class="card mb-4 card-hover ">
                  <div class="row">
                      <a href="" class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover rounded-start"><img src="admin/<?php echo $category['category_picture'] ?>" alt="" class="rounded-top-md card-img-top"></a>
